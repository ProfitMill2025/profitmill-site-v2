interface TestimonialsSectionProps {
  title?: string
  description?: string
  svgColor?: 'green' | 'mint' | string
}

export default function TestimonialsSection({
  title = "Curious what we can achieve together?",
  ...
  const getStrokeColor = (color: string) => {
    switch (color) {
      ...
      case 'mint':
        return '#B6FFCE'
      default:
        // If it's already a hex color or CSS color, use it directly
        return color
    }
  }

  const strokeColor = getStrokeColor(svgColor)
  return (
    <div className="relative bg-white">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden" style={{ zIndex: 0 }}>
        ...
        >
          ...
          {/* Vertical line through center - shorter */}
          <line
            x1="900"
            y1="0"
            x2="900"
      ...
      <section className="relative max-w-7xl mx-auto px-4 py-16 sm:px-6 lg:px-8" style={{ zIndex: 1 }}>
        ...
        <div className="relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* First testimonial */}
            <div className="bg-[#E3FFEB] p-6 rounded-lg md:col-span-2">
            ...
            {/* Second testimonial */}
            <div className="bg-[#E3FFEB] p-6 rounded-lg">
            ...
            <div className="bg-[#E3FFEB] p-6 rounded-lg">
              ...
              <blockquote className="text-[#001109] mb-4">
                &quot;He was instrumental at my last company in helping us scale our ad spend multiple times over. His strategic insights, coupled with his hands-on approach to campaign management, allowed us to achieve growth that we had never thought possible.&quot;
              </blockquote>
              <footer className="text-sm text-emerald-700">
