...
// Background 3D image
const bg3D = "https://res.cloudinary.com/dzn9bpr2h/image/upload/v1756844385/00b2276afac21c91f3bf88b1d7a4bf2618953099_of0fav.png"
                ...
                {logos.map((company, index) => (
                  <div key={index} className="h-[60px] md:h-[82px] w-[calc(33.333%-8px)] md:w-[175px] flex items-center justify-center">
                    <img
                      ...
                      className="object-contain opacity-80 max-w-[80px] max-h-[40px] md:max-w-[150px] md:max-h-[70px]"
                    />
                  </div>
                ))}
              </div>
